        ...
        <div className={styles['prognostic-ai-demo-results-container']}>
            ...
            <div className={styles['pai-dr-content']}>
                ...
                <div className={styles['pai-dr-visualization']}>
                    ...
                    {/*
                      We only have 6 data modules (2 columns x 3 rows).
                      Each module is absolutely positioned with partial offsets
                      so the upper modules do not fully cover the lower ones.
                      The internal animations (bars, lines, pies, etc.)
                      are expanded to have major 3-5x "analysis" movement.
                    */}
                    
                    {/* MODULE 1: Bar chart (Revenue Optimization) */}
                    ...
                    {/* MODULE 2: Line chart (Engagement Metrics) */}
                    <div className={styles['pai-dr-data-module']}>
                        <div className={styles['pai-dr-chart-header']}>
                            Engagement Metrics
                        </div>
                        <div className={styles['pai-dr-line-chart']}>
                            <div
                                className={styles['pai-dr-line']}
                                style={{ top: '55%', left: '10%', width: '70%', transform: 'rotate(-5deg)' }}
                            ></div>
                            <div
                                className={styles['pai-dr-line-point']}
                    ...
                    {/* MODULE 3: Pie chart (Growth Segments) */}
                    <div className={styles['pai-dr-data-module']}>
                        <div className={styles['pai-dr-chart-header']}>
                            Growth Segments
                        </div>
                        <div className={styles['pai-dr-pie-chart']}>
                            <div
                                ...
                                style={{ transform: 'rotate(0deg) skew(30deg)' }}
                            ></div>
                            <div
                                className={styles['pai-dr-pie-segment']}
                    ...
                    {/* MODULE 4: Thinking Tree (Strategic Roadmap) */}
                    <div className={styles['pai-dr-data-module']}>
                        <div className={styles['pai-dr-chart-header']}>
                            Strategic Roadmap
                        </div>
                        <div className={styles['pai-dr-tree']}>
                            {/* multiple nodes + branches for a 3-5x "complex" effect */}
                            <div className={styles['pai-dr-tree-node']} style={{top: '10%', left: '50%'}}></div>
                            <div className={styles['pai-dr-tree-branch']} style={{top: '15%', left: '48%', width: '20%', transform: 'rotate(40deg)'}}></div>
                            <div className={styles['pai-dr-tree-branch']} style={{top: '15%', left: '52%', width: '20%', transform: 'rotate(140deg)'}}></div>
                            
                            <div className={styles['pai-dr-tree-node']} style={{top: '35%', left: '35%'}}></div>
                            <div className={styles['pai-dr-tree-node']} style={{top: '35%', left: '65%'}}></div>
                            
                            {/* sub-branches */}
                            <div className={styles['pai-dr-tree-branch']} style={{top: '20%', left: '32%', width: '25%', transform: 'rotate(-10deg)'}}></div>
                            <div className={styles['pai-dr-tree-node']} style={{top: '28%', left: '46%'}}></div>
                            <div className={styles['pai-dr-tree-branch']} style={{top: '28%', left: '46%', width: '12%', transform: 'rotate(70deg)'}}></div>
                            <div className={styles['pai-dr-tree-node']} style={{top: '34%', left: '55%'}}></div>
                            <div className={styles['pai-dr-tree-branch']} style={{top: '34%', left: '55%', width: '15%', transform: 'rotate(110deg)'}}></div>
                        </div>
                    </div>
                    
                    {/* MODULE 5: Radar (Market Fit Analysis) */}
                    <div className={styles['pai-dr-data-module']}>
                        <div className={styles['pai-dr-chart-header']}>
                            Market Fit Analysis
                        </div>
                        <div className={styles['pai-dr-radar-chart']}>
                            ...
                            <div className={styles['pai-dr-radar-point']} style={{top: '80%', left: '20%'}}></div>
                            ...
                            <div className={styles['pai-dr-radar-line']} style={{top: '80%', left: '20%', width: '40%', transform: 'rotate(250deg)'}}></div>
                    ...
                    {/* MODULE 6: Brain Waves (Opportunity Mapping) */}
                    <div className={styles['pai-dr-data-module']}>
                        <div className={styles['pai-dr-chart-header']}>
                            Opportunity Mapping
                        </div>
                    ...
                    {/* Optional Grid overlay for visual effect */}
                    <div className={styles['pai-dr-grid']}></div>
                </div>
                
                {/* LOADING MESSAGE WITH FADE IN/OUT */}
                <div
