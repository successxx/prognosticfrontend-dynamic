{/* Futuristic data visualization with advanced psychoanalysis charts */}
                <div className={styles['pai-dr-visualization']}>
                    {/* No central core as requested */}
                    ...
                    {/* Psychographic profile with brain waves */}
                    <div className={styles['pai-dr-data-module']}>
                    ...
                    {/* Behavioral analytics - adding back */}
                    <div className={styles['pai-dr-data-module']}>
