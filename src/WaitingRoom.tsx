 ...
 * 
 * This version includes the left-aligned bullets and half-height chat box,
 * as requested.
 */
const WaitingRoom: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const updateCountdown = () => {
      ...
      if (timeLeft <= 0) {
        // old code used redirectToWebinar() here, but we no longer redirect automatically
  ...
  // We do *not* store the socket in a React state, because we don't read it anywhere.
    ...
    <div>
      ...
      <div className={styles.waitingroomWrapper}>
        ...
        <div className={styles.waitingroomLeft}>
          ...
          {/* "You will learn..." (left-aligned now) */}
