...
const WaitingRoom: React.FC = () => {
  // ====== COUNTDOWN STATE/LOGIC (same as original) ======
  ...
  /** Formats time left into "X minutes and Y seconds" or "Z seconds" */
  ...
  // ====== CHATBOX LOGIC (restored from your original working code) ======
  ...
  useEffect(() => {
    ...
    // Some attendee names & random messages
    const names = [
    ...
    function addMessage(
      ...
      // If it's a real host message (not auto), show "typing..."
      ...
      // If it's a participant (not "You"), hide/show based on toggle
      ...
      // Auto-scroll if near bottom or if user typed
      if (!isUserScrolling || user === 'You') {
        scrollToBottom(chatEl);
      }
    }

    // Toggle show/hide other participants
    ...
    // Randomly schedule some attendee messages
    ...
    // Randomly adjust viewer count  (ex: from 40..50)
    ...
    // Kick off initial host message, schedule random lines
    setTimeout(() => {
  ...
  return (
    <>
        ...
        <div className={styles.twoColumnLayout}>
          ...
          <div className={styles.leftColumn}>
            ...
            <ul className={styles.nextStepsList}>
              <li>Block out 1.5 hours. Add it to your calendar or set a reminder.</li>
              <li>Show up early and attend live. No recordings. Arrive at least 5 min early.</li>
              <li>Use a desktop computer (Mac or Windows). Mobile can be glitchy.</li>
              <li>Get the 3 secret AI tools we are giving away. Show up live to grab them!</li>
            </ul>
          </div>
      ...
      {/* Footer branding OUTSIDE the white box, centered */}
