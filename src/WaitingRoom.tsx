...
const WaitingRoom: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!chatEl || !inputEl || !typingEl || !toggleEl) {
      console.error("WaitingRoom: Missing one or more chat elements.");
      return;
    }
  ...
  return (
    <div className={styles.zoomContainer}>
      {/* TOP BAR mimicking the sign-up room header */}
      ...
      {/* Header countdown area (transplanted waiting room header) */}
      ...
      <div className={styles.twoColumnLayout}>
        {/* Left Column: Loading / “You will learn…” */}
