...
const App: React.FC = () => {
    ...
    const startPolling = () => {
        ...
        timeoutId.current = window.setTimeout(() => {
            stopPolling();
            setError("We couldn't process your request. Please try again, or contact support@psych.ai.");
            setLoading(false);
        }, 95000);
                            ...
                            <div className="wrapper">
                                <div className="inner">
                                    ...
                                    {loading ? (
                                        <>
                                            <LoadingCircle/>
                                            <p id="text07" className="style1">Processing...</p>
                                        </>
                                    ) : (
                                        <>
                                            <h1 id="text02"
                                                ...
                                                <span className="p">
                                                    Recommend Psych.<mark>AI</mark>
                                                    {' '}
                                                    <strong>To A Friend</strong>
                                                    <br/>
                                                    <a href="https://psych.ai" target="_blank"
                                                       rel="noopener noreferrer">
                                                        Help A Friend With Our Free Tools Today!
                                                    </a>
                                                </span>
                                            </h1>
                                            <hr id="divider01"
                                                    ...
                                                    <div className="row">
                                                        <div className="col-12">
                                                            {error ? (
                                                                ...
                                                                <TypedContent
                                                                    content={content}
                                                                    booking_button_name={booking_button_name || 'Return To Psych.ai Homepage'}
                                                                    booking_button_redirection={booking_button_redirection || 'https://psych.ai'}
                                                                />
