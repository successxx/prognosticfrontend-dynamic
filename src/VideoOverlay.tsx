  ...
  // Add this to the overlayItems array
{
  ...
  position: { x: 0.099, y: 0.335 }, // These are the estimated coordinates
  style: {
    color: "#252525",
  ...
  position: { x: 0.54, y: 0.25 }, // Centered under "personal", similar height to consultation text
  style: {
    color: "#252525",
    ...
    lineHeight: "1.4",
    textAlign: "center",
    maxWidth: "25em", // 30em = 30 × font size
    zIndex: "3"
  },
},
  {
